        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="name" name="name" className="col-span-3" defaultValue={location.name} required />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="address" className="text-right">
                Address
              </Label>
              <Input id="address" name="address" className="col-span-3" defaultValue={location.address} />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="type" className="text-right">
                Type
              </Label>
              <Select name="type" required defaultValue={location.type}>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Switch id="active" name="active" defaultChecked={location.active} />
            </div>
          </div>
          <DialogFooter>
